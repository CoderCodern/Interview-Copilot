    ...
    public partial class AddIdentityAndAuth : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    user_id = table.Column<Guid>(type: "uuid", nullable: false),
                    career = table.Column<string>(type: "jsonb", nullable: false),
                    resume_status = table.Column<string>(type: "jsonb", nullable: false),
                    theme = table.Column<string>(type: "text", nullable: false),
                    language = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false),
                    notification_settings = table.Column<string>(type: "jsonb", nullable: false),
                    onboarding = table.Column<string>(type: "jsonb", nullable: false),
                    created_at = table.Column<DateTimeOffset>(type: "timestamp with time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    created_ip_hash = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_user_identity_logins", x => new { x.LoginProvider, x.ProviderKey });
                    table.ForeignKey(
                        name: "FK_user_identity_logins_users_UserId",
                        column: x => x.UserId,
                        principalTable: "users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "ix_auth_audit_event_time",
                table: "auth_audit_logs",
                columns: new[] { "event", "created_at" });

            migrationBuilder.CreateIndex(
                name: "ix_auth_audit_user_time",
                table: "auth_audit_logs",
                columns: new[] { "user_id", "created_at" });

            migrationBuilder.CreateIndex(
                name: "ix_external_logins_user",
                table: "external_logins",
                column: "user_id");

            migrationBuilder.CreateIndex(
                name: "ux_external_logins_provider_key",
                table: "external_logins",
                columns: new[] { "provider", "provider_key" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "ix_refresh_tokens_lookup",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_user_identity_logins_UserId",
                table: "user_identity_logins",
                column: "UserId");
